...
try:
    ...
    model.summary()
    model.compile( optimizer=ke.optimizers.RMSprop(),loss=loss_f)#ke.losses.MeanSquaredError())#,metrics=[ke.losses.MeanSquaredError()])
...
for itr in range(1000):
    ...
    model.train_on_batch(x=observation[None,:],y=mask)
##    
